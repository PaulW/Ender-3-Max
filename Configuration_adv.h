 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    // Moons Stepper Motor C17HD2024-01N
    //   Likley rebranded BJ42D22-44V16 given matching Resistance/Phase of 3.6 Ohms)
    // Rated current (Max Current): 1A
    // Calculates RMS Current: Rated Current * 0.707 = 1A * 0.707 = 0.707A or 707mA
    // Safety Margin: 90% RMS Current = 707mA * 0.9 = 636mA
    ...
    // Unbranded Stepper Motor (Labelled Creality 42-34)
    // Could be 1 of 3:
    //   1. BJ42D22-44V16 (1.0A Current, 3.6 Ohms Resistance)
    //   2. BJ42D22-23V01 (1.5A Current??)
    //   3. JK42HS40-1004AC (1.0A Current, 3.9 Ohms Resistance/Phase)
    // Stepper has Resistance/Phase of 3.9 Ohms (Matches JK42HS40-1004AC)
    // Rated current: 1.0A (Based on JK42HS40-1004AC)
    // Calculates RMS Current: Rated Current * 0.707 = 1A * 0.707 = 0.707A or 707mA
    // Safety Margin: 90% RMS Current = 707mA * 0.9 = 636mA
    ...
    // We are running Dual Z Steppers in Parallel
    // Stepper 1 (Left):
    //   Stepper: BJ42D15-26V19
    //   Rated current: 0.84 (Assuming matches that of BJ42D15-26V09)
    // Stepper 2 (Right):
    //   Stepper: BJ42D15-26V12
    //   Rated current: 0.84 (Assuming matches that of BJ42D15-26V09)
    // Total Current: 0.84A + 0.84A = 1.68A
    // Calculate RMS Current: Rated Current * 0.707 = 1.68A * 0.707 = 1.19A or 1190mA
    // Safety Margin: 80% RMS Current = 1190mA * 0.8 = 952mA
    #define Z_CURRENT       952
    ...
    // Stepper: BJ42D09-20V02
    // Rated current: 0.84A
    // Calculate RMS Current: Rated Current * 0.707 = 0.84A * 0.707 = 0.594A or 594mA
    // Safety Margin: 90% RMS Current = 594mA * 0.9 = 535mA
    #define E0_CURRENT      535
